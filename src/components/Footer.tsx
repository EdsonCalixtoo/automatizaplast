...
const Footer = () => (
  <footer className="bg-[#0a1e36] text-white border-t border-white/5 mt-20">
    <div className="container mx-auto px-6 pt-20 pb-10">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
        ...
        <div>
          ...
          <ul className="space-y-6">
            <li>
              <a href="https://wa.me/5519983986895" className="flex items-start gap-4 text-slate-400 hover:text-primary transition-colors duration-300 group">
                <div className="w-10 h-10 bg-white/5 rounded-xl flex items-center justify-center shrink-0 group-hover:bg-primary group-hover:text-white transition-colors">
                  <MessageCircle className="w-5 h-5 text-primary group-hover:text-white" />
                </div>
                <div>
                  <p className="font-bold text-white text-lg leading-tight uppercase tracking-tighter" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>(19) 98398-6895</p>
                  <p className="text-[10px] font-bold uppercase tracking-widest">WhatsApp disponível</p>
                </div>
              </a>
            </li>
            <li>
              <a href="tel:19983986895" className="flex items-start gap-4 text-slate-400 hover:text-primary transition-colors duration-300 group">
                <div className="w-10 h-10 bg-white/5 rounded-xl flex items-center justify-center shrink-0 group-hover:bg-white group-hover:text-[#0a1e36] transition-colors">
                  <Phone className="w-5 h-5 text-primary group-hover:text-[#0a1e36]" />
                </div>
                <div>
                  <p className="font-bold text-white text-lg leading-tight uppercase tracking-tighter" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>(19) 98398-6895</p>
      ...
      {/* Bottom Footer */}
      <div className="border-t border-white/5 pt-10 flex flex-col md:flex-row items-center justify-between gap-6 text-slate-500 text-[10px] font-black uppercase tracking-[0.2em] font-['Barlow_Condensed']">

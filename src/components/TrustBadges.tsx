...
const badges = [
  ...
  },
  {
    ...
    desc: "Todos os nossos produtos em Plástico ABS possuem garantia direta de fábrica contra defeitos.",
  },
  {
    icon: CreditCard,
    title: "5x Sem Juros",
    desc: "Parcele seu kit em até 5x sem juros ou 12x com juros. Oferecemos condições especiais para PIX.",
  },
  {
    icon: Package,
    title: "Plástico ABS Industrial",
    desc: "Usamos tecnologia de injeção em ABS, garantindo peças leves, lisas e extremamente resistentes.",
  },
  {
    icon: Star,
